...
public class STBoardView: UIView {
    
    public var headerView: STBoardHeaderView!
    public var footerView: STBoardFooterView!
    public var tableView: STShadowTableView!
    public var topShadowBar: UIImageView!
    public var bottomShadowBar: UIImageView!
    public weak var tableBoard: STTableBoard!
